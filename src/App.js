...
const MovieInfo = [
...

  {
    ...
    title: "SAVAGE BEAUTY",
    description:
      "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Id faucibus nisl tincidunt eget nullam non nisi est sit. ",
    posterURL:
...

  {
    ...
    title: "VIVO",
    description:
      "Non nisi est sit amet facilisis. Purus sit amet luctus venenatis lectus magna.",
    posterURL:
...

  {
    ...
    title: "WISH DRAGON",
    description:
      "Nibh tellus molestie nunc non blandit massa enim. Fermentum odio eu feugiat pretium nibh ipsum consequat. Scelerisque in dictum non consectetur a",
    posterURL:
...

  {
    ...
    title: "MEGA MIND",
    description:
      "Vulputate mi sit amet mauris commodo quis. Eget mi proin sed libero enim sed faucibus. Elit pellentesque habitant morbi tristique senectus et. Nunc vel risus commodo viverra.",
    posterURL:
